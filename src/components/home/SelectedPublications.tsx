                    ...
                    >
                        ...
                        {pub.code && (
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                aria-label={`Code: ${pub.title}`}
                                className="mt-2 inline-flex rounded py-1 text-sm font-medium text-accent underline decoration-accent/40 underline-offset-2 hover:decoration-accent focus-visible:outline-2 focus-visible:outline-accent"
                            >
